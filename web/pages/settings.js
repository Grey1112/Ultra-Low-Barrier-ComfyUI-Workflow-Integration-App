  ...
  return h('div', { className: 'page' },
    ...
    h('div', { className: 'settings-grid' },
      ...
      h('div', { className: 'card' },
        ...
        h(Field, { label: t('settings.llm.keepMessages'), hint: t('settings.llm.keepMessages.hint') },
          h('input', { className: 'input narrow', type: 'number', min: 2, max: 2000, value: llm.keepMessages === undefined ? 40 : llm.keepMessages, onChange: (e) => setLlm({ ...llm, keepMessages: e.target.value }) })),
